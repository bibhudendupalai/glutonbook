...
class BookView(APIView):
    ...
    def get(self,request):
        ...
        author_year_end = self.request.data.get('author_year_end')
        try:
        ...
        author_year_start = self.request.data.get('author_year_start')
        try:
        ...
        copyright_parameter = self.request.data.get('copyright')
        ...
        id_string = self.request.data.get('ids')
        print(id_string)
        ...
        language_string = self.request.data.get('languages')
        ...
        search_string = self.request.data.get('search')
